...
import {
  Inbox, BarChart3, Settings, ArrowUpRight, ArrowDownRight,
...
/* ────────────────────────────────────────────────────────────────────────
   Sidebar (dashboard variant — no inbox filters)
   ──────────────────────────────────────────────────────────────────────── */

function DashboardSidebar() {
  const router = useRouter()
  return (
    <aside className="w-60 flex-shrink-0 flex flex-col border-r border-gray-100 bg-white min-h-0">
